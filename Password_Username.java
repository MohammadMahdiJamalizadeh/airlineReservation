...
//    static public ArrayList <String>password_list = new ArrayList();
//    static public ArrayList <String>username_list = new ArrayList();
//    //--------------Variable----------------//
//    private int num;
//    private int sum = 0;
//    private static String username_up;
//    private static String password_up;
...
//        }
//    }
//    public static void Set_a_new_username_and_password(){
//        Scanner scanner2 = new Scanner(System.in);
//        System.out.println(ANSI_PURPLE+"NEW USERNAME : "+ANSI_RESET);
//        setPassword_up(scanner2.next());
...
//    }
//
//    public static String getUsername_up() {
//        return username_up;
//    }
//
//    public static void setUsername_up(String username_up) {
//        Password_Username.username_up = username_up;
//    }
//
//    public static String getPassword_up() {
//        return password_up;
//    }
//
//    public static void setPassword_up(String password_up) {
//        Password_Username.password_up = password_up;
//    }
//
